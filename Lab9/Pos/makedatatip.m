function varargout = makedatatip(hObj,index, title, labels)
...
output_text = {[char(str), ''], [char(labels(1)),num2str(pos(1))],[char(labels(2)),num2str(pos(2))]};
