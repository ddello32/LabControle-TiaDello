...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Controlador proporcional por amortecimento crítico
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('Tempo(s)')
ylabel('Amplitude(V)')
legend('Saída Filtrada','Entrada')
title('Controlador proporcional por amortecimento crítico')
saveas(yc,'ypidc.eps','epsc')
%% plot de esforço de controle
uc=figure;
plot(t,controlec)
xlabel('Tempo(s)')
ylabel('Amplitude(V)')
legend('Esforço de controle')
title('Esforço de controle do controlador proporcional por amortecimento crítico')
...
xlabel('Tempo(s)')
ylabel('Amplitude(V)')
legend('Saída Filtrada','Entrada','Esforço Contr.')
title('Controlador proporcional por amortecimento crítico')
...
ylabel('Amplitude(V)')
legend('Esforço de controle')
title('Esforço de controle do controlador proporcional por overshoot de 2%')
...
ylabel('Amplitude(V)')
legend('Esforço de controle')
title('Esforço de controle do controlador PID por Ziegler-Nichols')
...
ylabel('Amplitude(V)')
legend('Esforço de controle')
title('Esforço de controle do controlador PID por SISO Design Tool')
...
xlabel('Tempo(s)')
ylabel('Amplitude(V)')
legend('Saída Simulada','Entrada','Esforço Contr.')
title('Simulação do controlador proporcional por amortecimento crítico')
...
ylabel('Amplitude(V)')
legend('Saída Simulada','Entrada','Esforço Contr.')
title('Simulação do controlador proporcional por overshoot de 2%')
...
ylabel('Amplitude(V)')
legend('Saída Simulada','Entrada','Esforço Contr.')
title('Simulação do controlador PID por Ziegler-Nichols')
...
ylabel('Amplitude(V)')
legend('Saída Simulada','Entrada','Esforço Contr.')
title('Simulação do controlador PID por SISO Design Tool')
