...
Esperando a velocidade do motor se estabilizar, chegamos em $\nu_{\infty}=155.3764$. Considerando que a esse ponto o indutor se comporte como curto circuito, e que $\phi=c\theta$, encontramos a constante de torque do motor conforme a equação \ref{eq:k}
...
Com a velocidade estabilizada, desligando a alimentação do motor, conseguimos calcular a constante de tempo $\tau_m=29.6943$ em que $\nu(\tau_m)=0.3679\nu_{\infty}$. Depois, encontramos $J$ de acordo com a equação \ref{eq:j}.
