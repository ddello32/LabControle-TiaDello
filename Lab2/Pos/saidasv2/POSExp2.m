...
k21 = max(y2p)/r2p(500);
k2 = k21/k1;
ta1 = find(((0.98)*max(y2p)-5e-6 <= y2p).*(y2p <= (0.98)*max(y2p) + 5e-6));
ta1 = ta1(1);
tao2 = tp(ta1)/4;
figure,
hax = axes;
...
k321 = y3p(500)/r3(500);
k3 = k321/k2/k1;
ta1 = find((tao2-5e-4 <= tp).*(tao2+5e-4 >= tp));
ta1 = ta1(1);
ta2 = find((2*tao2-5e-4 <= tp).*(2*tao2+5e-4 >= tp));
ta2 = ta2(1);
figure,
...
sim4 = lsim(g1*g2*g3*g4, r4(1:3000), t4(1:3000));
figure,
plot(t4(1:3000), sim4, t4(1:3000), y4(1:3000))