...
\begin{frame}
	...
	\begin{block}{Novo controlador PI}
		\begin{center}
			\scalebox{1}{ %
				$K(s) = \kappa_p + \frac{\kappa_i}{s} = 0.5 + \frac{0.1}{s}$
			}
			\begin{center}
			\resizebox{\textwidth}{!}{%
			\includegraphics[height=0.7\linewidth]{../rbla0101}
			\quad
			\includegraphics[height=0.7\linewidth]{../bla0101}
			}
			\end{center}
		\end{center}
	\end{block}
...
\begin{frame}
	...
	\begin{center}
		\resizebox{\textwidth}{!}{%
			\includegraphics[height=0.6\linewidth]{../bla0501medido}
			\quad
			\includegraphics[height=0.6\linewidth]{../bla0501esforco}
		}
	\end{center}
\end{frame}
